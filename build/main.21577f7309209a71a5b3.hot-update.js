...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Empolyees, [{
    ...
    value: function render() {
      ...
      console.log(this.props.data.data !== undefined && this.props.data.data.length);
      ...
      })), offset, data.length, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        style: {
          marginTop: 10
        },
...
//# sourceMappingURL=main.21577f7309209a71a5b3.hot-update.js.map